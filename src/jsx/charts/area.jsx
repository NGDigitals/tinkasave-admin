        ...
        switch (timeline) {
            case 'one_month':
                this.setState({
                    options: {
                        xaxis: {
                            min: oneMonth.toDate().getTime(),
                            max: currentDate.toDate().getTime(),
                        }
                    }
                })
                break;
            ...
            case 'ytd':
                this.setState({
                    options: {
                        xaxis: {
                            min: startOfYear.toDate().getTime(),
                            max: currentDate.toDate().getTime(),
                        }
                    }
                })
